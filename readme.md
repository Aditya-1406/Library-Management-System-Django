...
Key Points :-
1. After creating the superuser, you have to create a member also. Then using superuser, you can make the user admin and explore the app.
2. Install all the required lib from requirements.txt file
